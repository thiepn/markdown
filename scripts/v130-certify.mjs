...
const grading=read('assets/v130/grading-fix.js');
...
new vm.Script(grading,{filename:'v130-grading-fix.js'});console.log('PASS · v1.3.0 grading hardening JavaScript parses');
...
const gradingAt=loader.indexOf('assets/v130/grading-fix.js');
...
assert(p11>=0&&v101>p11&&v110>v101&&v120>v110&&v130>v120&&gradingAt>v130&&v130Gate>gradingAt&&v120Gate>v130Gate&&v110Gate>v120Gate&&v101Gate>v110Gate&&p12>v101Gate,'loader order applies learning and grading after workbench and before regression gates');
...
const report={gate:'V130_REPOSITORY_CERTIFIED',version:'1.3.0',release_state:manifest.release_state,learning_git_blob_sha1:gitBlobSha(learning),grading_fix_git_blob_sha1:gitBlobSha(grading),browser_gate_git_blob_sha1:gitBlobSha(browserGate),labs:13,levels:3,exercises:39,browser_checks:11,live,checked_at:new Date().toISOString()};
